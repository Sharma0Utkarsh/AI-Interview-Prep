...
const SummaryCard = ({
  ...
  >
    ...
    >
        ...
        <div className='hidden group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer absolute top-0 right-0'>
            <div className='px-3 pb-3'>
                <div className='flex items-centre gap gap-3 mt-4'>
                    Experience: {experience} {experience == 1 ? "Year" : "Years"}
                </div>
                <div className='text-[10px] font-medium text-black px-3 py-1 border-[0.5] border-gray-900 rounded-full'>
                    {questions} Q&A
                </div>
                <div className='text-[10px] front-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-fully'>
